...
def coco_to_json_converter(
    coco_json_file_path: str,
    coco_to_json_output_dir: str
):
    ...
    for image in coco_json['images']:
        ...
        yolo_txt_file = os.path.join(coco_to_json_path, image_filename.replace('.jpg', '.txt'))
...
if __name__ == '__main__':
    ...
    setup_logging(log_level=logging.DEBUG, log_dir=f'{par_dir}/output/logs', log_file='coco_to_yolo_log.txt')
    coco_to_json_converter(
        coco_json_file_path=f'{par_dir}/data/coco/annotations/instances_val2017.json',
        coco_to_json_output_dir=f'{par_dir}/data/coco_to_yolo'
    )
